...
void RegisterValidationInterface(CValidationInterface *pwalletIn) {
    ...
    g_signals.TransactionRemovedFromMempool.connect(boost::bind(&CValidationInterface::TransactionRemovedFromMempool, pwalletIn, _1, _2, _3, _4));
...
void UnregisterValidationInterface(CValidationInterface *pwalletIn) {
    ...
    g_signals.TransactionRemovedFromMempool.disconnect(boost::bind(&CValidationInterface::TransactionRemovedFromMempool, pwalletIn, _1, _2, _3, _4));
